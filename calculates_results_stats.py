...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['pct_match'] =(results_stats_dic['n_images']/ results_stats_dic['n_match'])*100.0
    ...
    results_stats_dic['pct_correct_dogs'] = 100.0 * (results_stats_dic.get('n_correct_dogs')/results_stats_dic.get('n_dogs_img'))
    ...
    results_stats_dic['pct_correct_breed'] = 100.0 * (results_stats_dic.get('n_correct_breed')/results_stats_dic.get('n_dogs_img'))
